...
To modify the pipelines for `model-registry-operator` in the `rhoai-3.5-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for model-registry-operator (rhoai-3.5-ea.1)"
